...
plugins=(git aliases autoswitch_virtualenv)
...
source /root/.oh-my-zsh/ls-colors/ls-colors.zsh my-lscolors legacy
source /root/.oh-my-zsh/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
